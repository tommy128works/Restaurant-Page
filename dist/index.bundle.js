(() => {
  ...
  var e = {
      192: (e, t, n) => {
        ...
        var r = n(81),
          ...
          a = n(645),
          i = n.n(a)()(o());
        i.push([e.id, ".center{display:flex;justify-content:center}", ""]);
        const c = i;
      },
      645: (e) => {
  ...
  (n.n = (e) => {
    ...
    (() => {
      ...
      h.setAttribute("id", "content"), document.body.appendChild(h);
      const y = document.getElementById("content");
      console.log("Hello world!"), y.appendChild((0, m.Z)());
    })();
})();
